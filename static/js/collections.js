class CollectionsManager {
    constructor() {
        ...
        document.getElementById('exportApiBtn')?.addEventListener('click', () => {
            document.getElementById('exportApiModal').classList.add('active');
        });
    ...
    setupEventListeners() {
        ...
        document.getElementById('importCollectionBtn')?.addEventListener('click', () => {
            document.getElementById('importCollectionModal').classList.add('active');
        });
